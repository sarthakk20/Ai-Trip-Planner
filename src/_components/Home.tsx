...
import { Mountain, Parasol, Plane, Send } from "lucide-react";
...
const Home = () => {
    return (
        ...
        <div className='text-white mt-24 w-full h-auto flex flex-col items-center justify-center gap-10'>
            ...
            />
            <button className="absolute bottom-3 right-4 text-black hover:text-white transition-colors bg-amber-500 rounded-4xl p-3">
                <Send size={20} />
            </button>
            </div>
            ...
            <div  className='w-full text-center px-2'>
                <ul className='flex items-center justify-center gap-3 text-[6px] sm:text-[10px] md:text-xs'>
                    <li className='flex items-center justify-center border border-gray-400 rounded-full p-2 hover:bg-orange-400 transition-colors cursor-pointer '>
